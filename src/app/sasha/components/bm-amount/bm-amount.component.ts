...
@Component({
  selector: 'app-bm-amount',
  templateUrl: './bm-amount.component.html',
  styleUrls: ['./bm-amount.component.scss'],
})
export class BmAmountComponent implements OnInit, ControlValueAccessor {
  @Input() maxRating = 5;
